...
- [Rematch Default Reducers](#rematch-default-reducers)
  ...
  - [Documentation](#documentation)
    ...
    - [**Common Default Reducers**](#common-default-reducers)
      - [`dispatch.${modelName}.set(payload, [meta])`](#dispatchmodelnamesetpayload-meta)
      - [`dispatch.${modelName}.reset()`](#dispatchmodelnamereset)
    - [**The `rootState` Model and Reducers**](#the-rootstate-model-and-reducers)
      - [`dispatch.rootState.set(payload, [meta])`](#dispatchrootstatesetpayload-meta)
