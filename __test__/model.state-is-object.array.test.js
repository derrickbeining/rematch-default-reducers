    ...
    context('and state.property is type Array', function() {
      ...
      specify(
        ...
        function() {
          ...
          dispatch.modelWithObjectState.setWords([])
          dispatch.modelWithObjectState.concatWords(words)
          dispatch.modelWithObjectState.insertWord({payload, where: predicate})
      ...
      specify(
        ...
        function() {
          ...
          dispatch.modelWithObjectState.setWords([])
          dispatch.modelWithObjectState.concatWords(words)
          dispatch.modelWithObjectState.insertWords({payload, where: predicate})
      ...
      specify(
        ...
        function() {
          ...
          dispatch.modelWithObjectState.setWords(words)
          dispatch.modelWithObjectState.removeWord({where: (el, i) => i === 2})
